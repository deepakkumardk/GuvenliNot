...
object Hash {
    ...
    fun decode(string: String): String {
        return if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            android.util.Base64.decode(string.toByteArray(Charsets.UTF_8), android.util.Base64.DEFAULT).toString(Charsets.UTF_8)
        }
    }
    /**
    ...
    fun encode(string: String): String {
        return if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
           ...
           android.util.Base64.encodeToString(string.toByteArray(Charsets.UTF_8), android.util.Base64.DEFAULT)
       }
    }
}